...
COPY "./src/bsidescol25" "/app/bsidescol25"
...
LABEL org.opencontainers.image.url="https://github.com/jonzeolla/bsidescol25"
LABEL org.opencontainers.image.source="https://github.com/jonzeolla/bsidescol25/tree/${COMMIT_HASH}"
